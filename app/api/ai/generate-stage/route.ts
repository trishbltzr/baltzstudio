    ...
    sections: {
      ...
      items: {
        ...
        properties: {
          ...
          heading: { type: "string", minLength: 1, maxLength: 78 },
          body: { type: "string", minLength: 1, maxLength: 240 },
          bullets: { type: "array", maxItems: 4, items: { type: "string", minLength: 1, maxLength: 110 } },
          cta: { anyOf: [{ type: "string", minLength: 1, maxLength: 32 }, { type: "null" }] },
