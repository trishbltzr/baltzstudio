  ...
  const byStage: Record<ClientLifecycleStage, ProjectWorkflow> = {
    "cocoon-consult": {
      ...
      notifications: [
        ...
        { id: "wf-audit-generated", type: "audit_generated", actor: "Baltazar Studio", action: "generated", target: "Cocoon Consult audit results", date: "Jun 4, 2026", clientVisible: true },
    ...
    "paid-cocoon": {
      ...
      sidebarNudgeBody: "Use the Cocoon Consult findings to move into Winged in a Week when you are ready for implementation.",
      ...
      dashboardAccess: { kind: "three_month", label: "Three-month Cocoon Consult dashboard access", startsAt: "Jun 5, 2026", endsAt: "Sep 5, 2026", status: "active" },
    ...
    "wiaw-active": {
      ...
      planDescription: "Full website build and launch using the Cocoon Consult audit as the strategy foundation.",
    ...
    deleted: {
      ...
      planDescription: "The previous Cocoon Consult audit and dashboard access expired after no continuation. A new Cocoon Consult is required before restarting.",
...
function planForStage(stage: ClientLifecycleStage): ProjectPlan {
  const plans: Record<ClientLifecycleStage, ProjectPlan> = {
    ...
    "wiaw-active": {
      ...
      description: "Full website build and launch using the Cocoon Consult audit as the strategy foundation.",
      status: "active",
...
export const WIAW_PROJECT: Project = {
  ...
  status: "active",
  notes: [
    { id: "flora-wiaw-note-1", content: "WIAW starts as its own build workflow after Cocoon Consult. Do not carry completed Cocoon Consult audit tasks into the build milestones.", author: "Trisha", date: "Jun 7, 2026" },
    { id: "flora-wiaw-note-2", content: "Use the Cocoon Consult findings as strategy input only. Foundation, design, build, QA, launch, and handoff should progress inside the WIAW workflow.", author: "Trisha", date: "Jun 7, 2026" },
  ],
