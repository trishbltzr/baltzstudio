...
const API_KEYS_BY_MODE: Record<AiGenerationMode, readonly string[]> = {
  audit: ["OPENAI_WEB_AUDIT_API_KEY", "OPENAI_WEB-AUDIT_API_KEY", "OPENAI_AUDIT_API_KEY", "OPENAI_API_KEY"],
  brand: ["OPENAI_BRAND_AUDIT_API_KEY", "OPENAI_BRAND-AUDIT_API_KEY", "OPENAI_API_KEY"],
  seo: ["OPENAI_SEO_AUDIT_API_KEY", "OPENAI_SEO-AUDIT_API_KEY", "OPENAI_AUDIT_API_KEY", "OPENAI_API_KEY"],
  website_builder: ["OPENAI_WEB_BUILDER_API_KEY", "OPENAI_WEB-BUILDER_API_KEY", "OPENAI_WEBSITE_BUILDER_API_KEY", "OPENAI_WEBSITE-BUILDER_API_KEY", "OPENAI_API_KEY", "OPENAI_CHAT_API_KEY"],
  funnel: ["OPENAI_FUNNEL_BUILDER_API_KEY", "OPENAI_FUNNEL-BUILDER_API_KEY", "OPENAI_FUNNEL_API_KEY", "OPENAI_API_KEY"],
};
...
export function socialMediaApiKey() {
  return readEnv("OPENAI_SOCIAL_MEDIA_BUILDER_API_KEY", "OPENAI_SOCIAL-MEDIA-BUILDER_API_KEY", "OPENAI_API_KEY");
}
