...
const API_KEYS_BY_MODE: Record<AiGenerationMode, readonly string[]> = {
  audit: ["OPENAI_API_KEY", "OPENAI_WEB_AUDIT_API_KEY", "OPENAI_AUDIT_API_KEY"],
  brand: ["OPENAI_API_KEY", "OPENAI_BRAND_AUDIT_API_KEY"],
  seo: ["OPENAI_API_KEY", "OPENAI_SEO_AUDIT_API_KEY", "OPENAI_AUDIT_API_KEY"],
  website_builder: ["OPENAI_API_KEY", "OPENAI_WEB_BUILDER_API_KEY", "OPENAI_WEBSITE_BUILDER_API_KEY"],
  funnel: ["OPENAI_API_KEY", "OPENAI_FUNNEL_BUILDER_API_KEY", "OPENAI_FUNNEL_API_KEY"],
};
...
export function socialMediaApiKey() {
  return readEnv("OPENAI_API_KEY", "OPENAI_SOCIAL_MEDIA_BUILDER_API_KEY");
}
