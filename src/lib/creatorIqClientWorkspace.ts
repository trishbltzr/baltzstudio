...
export const CREATOR_IQ_FUNNEL_DATA = {
  ...
  name: "CreatorIQ Enterprise Funnel",
...
export function createCreatorIqClientWorkspace(): PortalClientWorkspace {
  const brandProcessRun = syncPortalProcessRun(undefined, {
    processId: "brand-audit",
    runId: "creator-iq-brand-checkup",
  ...
  return {
    ...
    approvals: [{
      ...
      sections: [{ heading: "Ready outputs", body: "CreatorIQ client workspace", bullets: ["Website audit", "Brand audit", "SEO audit", "Website builder", "Funnel builder", "Social calendar"] }],
    }],
    proposal: null,
    collaborators: [],
    files: [],
    funnelPlans: [],
    notes: [{ id: "creator-iq-portal-note", text: "Keep the enterprise platform story focused on intelligence, workflow, governance, measurement, and a clear demo path.", author: "Baltz Studio", createdAt: UPDATED_AT }],
